...
const PaymentSuccessForm: React.FC<PaymentSuccessFormProps> = ({
  ...
  return (
    <motion.div
      ...
      className="flex items-center justify-center p-8 bg-white rounded-lg shadow-lg mt-10 "
    >
      <motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
      ...
      <h2 className="text-2xl mt-30 font-bold text-gray-800 mb-4">Payment Successful!</h2>
